...
This course is by no means an exhaustive overview of machine learning. The course focuses almost exclusively on *supervised* models which perform *empirical risk minimization*. This focus allows us to study a wide variety of classical models while building up a skillset that will give us a smooth on-ramp into deep learning towards the end of the course. 
...
- **Week 1**: Welcome! Data science techniques in Python. 
- **Week 2**: Black-box classification in practice. Features, model evaluation.
- **Week 3**: Vectorization. Flex. 
- **Week 4**: Bias and fairness. Auditing models. 
- **Week 5**: Introduction to theory: empirical risk minimization. Convex optimization.  
- **Spring Break!**
- **Week 6**: Optimization: deterministic and stochastic. 
- **Week 7**: Kernel methods. 
- **Week 8**: Deep learning. Image classification.  
- **Week 9**: Text classification and word embedding. 
- **Week 10**: Generative language models. 
- **Week 11**: Generative models: promises and risks. 
...
At the beginning of the semester, you'll write a process letter that will outline what you'd like to learn and achieve in the course. It's ok if you don't meet all your aspirations by the end of the course. That said, you are still accountable to yourself and to me, in the following way: 

> For an A, a student should spend at least **10 productive hours per week** of work outside of class. 

How you spend those 10 hours is largely up to you and your goals. Some examples: 

- You complete almost all of the assignments that I offer you, to a high degree of quality. 

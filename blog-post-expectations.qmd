...
Once your blog post is published on your blog: 

1. Print the webpage as a PDF. 
2. Check the PDF to make sure that all your math, plots, etc. look good. 
3. Submit the PDF to the assignment on Canvas. 
4. **To submit a revision**, just include a link to your new blog post. 

...
First, you'll need to join Slack. Just follow the link on the [Canvas syllabus page](https://middlebury.instructure.com/courses/13859/assignments/syllabus) to join the workspace. You may choose to download the Slack desktop client, but that's up to you. You can make your own choices about notifications, but please do whatever you need to do to ensure that you're able to check Slack on a regular basis. 
...
We now need to test your installation. We are going to do this by checking that you are able to run code from these packages in a Jupyter notebook. You can use any software you like for editing Jupyter notebooks. Below, I supply instructions for working in JupyterLab, which is easiest and most reliable. I personally prefer [VSCode](https://code.visualstudio.com/docs/datascience/jupyter-notebooks)'s notebook capabilities, but it can be a little bit more finicky to connect your kernel to your notebook. 

To test your installation with JupyterLab...

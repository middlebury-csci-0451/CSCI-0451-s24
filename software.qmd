...
You may use Slack in the browser, or you may choose to download the Slack desktop client,
but that's up to you.

You can make your own choices about notifications,
but please do whatever you need to do to ensure that you're able to check Slack on a regular basis. 
...
conda config --add channels pytorch conda-forge
...
```bash
conda install nb_conda numpy matplotlib pandas scikit-learn seaborn pytorch torchvision torchtext torchdata
```

You are now ready to skip to the next section to [Test Your Installation](#test-your-installation).
...
- Ensure that the installed Python is some version of Python 3.11 (so 3.11.1 is as valid as 3.11.8). 

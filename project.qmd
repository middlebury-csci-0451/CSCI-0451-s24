...
2. **The project software**, (aka the GitHub repository itself) due at the end of finals week. [Essay projects may not have associated software, in which case the repository should hold the files defining the essay (like quarto or LaTeX) files.]{.aside}
